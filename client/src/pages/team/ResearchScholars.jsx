      ...
      <div className="min-h-screen bg-background text-foreground">
        <section className="relative overflow-hidden border-b border-border bg-surface">
          ...
          <div className="mx-auto w-full max-w-7xl px-6 lg:px-10 py-20 lg:py-28">
            ...
            <h1 className="mt-6 max-w-3xl text-4xl font-medium leading-[1.05] tracking-tight text-foreground sm:text-5xl lg:text-6xl">Research Team</h1>
            <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted-foreground">Researchers and postdoctoral fellows turning ideas into deployable systems.</p>
          </div>
        </section>

        <section className="py-20">
          <div className="mx-auto w-full max-w-7xl px-6 lg:px-10 ">
            <h2 className="text-2xl font-medium tracking-tight">Research Scholars</h2>
            {loading ? (
