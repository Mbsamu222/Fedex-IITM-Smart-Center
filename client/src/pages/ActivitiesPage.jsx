      ...
      <div className="min-h-screen bg-background text-foreground pb-20">
        <section className="relative overflow-hidden border-b border-border bg-surface">
          ...
          <div className="mx-auto w-full max-w-7xl 2xl:max-w-[1536px] 3xl:max-w-[1800px] 4xl:max-w-[2200px] px-6 lg:px-10 2xl:px-12 3xl:px-16 py-20 lg:py-28 2xl:py-36">
            ...
            <h1 className="mt-6 max-w-3xl 2xl:max-w-4xl text-4xl font-medium leading-[1.05] tracking-tight text-foreground sm:text-5xl lg:text-6xl 2xl:text-7xl">Stay informed with the latest updates.</h1>
            <p className="mt-6 max-w-2xl 2xl:max-w-3xl text-lg 2xl:text-xl leading-relaxed text-muted-foreground">Explore current and past announcements, job postings, seminars, workshops, and other key activities from the IIT Madras-led FedEx SMART Center.</p>
          </div>
        </section>
