...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border/60 bg-background/80 backdrop-blur-xl">
      <div className="mx-auto w-full max-w-7xl px-6 lg:px-10 flex h-20 items-center gap-6 justify-between lg:justify-start">
        <Link className="flex shrink-0 items-center gap-3 lg:mr-12 xl:mr-20" to="/" onClick={closeMenu}>
